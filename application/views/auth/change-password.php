                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('auth/changepassword'); ?>" method="post">
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="password1" name="password1" placeholder="Enter New Password..." value="<?= set_value('password1'); ?>">
                                        <?= form_error('password1', '<small class="text text-danger pl-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <?= form_error('password2', '<small class="text text-danger pl-2">', '</small>'); ?>
                                    </div>
